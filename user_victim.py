...
class Victim:
    def __init__(self):
        ...
        self.cookie = CryptoUtils.generate_cookie(8)
    ...
    def request(self, step):
        ...
        if step == 0:
            ...
            s = self.byte_shifting_part[:-step]
    ...
    def start(self):
        ...
        for i in range(8):
            ...
            encoded = CryptoUtils.encrypt(request, iv)
            ...
            for j in ALPHANUMERIC:
                ...
                encoded = CryptoUtils.encrypt(modified_req, iv)
